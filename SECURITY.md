...
### v1.6.3 (2026-04-21)
- ✅ 聚类 ANN 预过滤（~100x 加速，CPU 从 ~100% 降至 ~5%）
- ✅ 原型数据 TTL 缓存（避免每批重加载 22K 人物原型）
- ✅ 修复聚类空转循环（Active vs Total 判断）

### v1.6.2 (2026-04-21)
- ✅ ANN 索引 HNSW M=8 + 30min 重建冷却（构建 4m23s→~2min，平均 CPU ~7%）

### v1.6.1 (2026-04-21)
- ✅ 合并建议 HNSW ANN 加速（100x+，20K+ 人物规模）
